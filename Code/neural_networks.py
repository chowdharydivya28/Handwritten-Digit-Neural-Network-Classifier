...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        ###############################################################################################
        W = np.random.normal(0.0, 0.1, (input_D, output_D))
        b = np.random.normal(0.0, 0.1, (1, output_D))
        self.params['W'] = W
        self.params['b'] = b
        # print("done weights")
        ...
        ###############################################################################################
        grad_W = np.zeros((input_D, output_D))
        grad_b = np.zeros((1, output_D))
        self.gradient['W'] = grad_W
        self.gradient['b'] = grad_b
        # print("done gradient")
        # raise NotImplementedError("Not Implemented function: __init__, class: linear_layer")
...
class relu:
    ...
    def backward(self, X, grad):
        ...
        ####################################################################################################
        self.mask[np.where(self.mask > 0.0)] = 1.0
